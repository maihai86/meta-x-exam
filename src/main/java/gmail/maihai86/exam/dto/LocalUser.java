...
public class LocalUser extends User implements OAuth2User, OidcUser {
    ...
    private gmail.maihai86.exam.model.User user;
    ...
    public LocalUser(final String userID, final String password, final boolean enabled, final boolean accountNonExpired, final boolean credentialsNonExpired,
                     final boolean accountNonLocked, final Collection<? extends GrantedAuthority> authorities, final gmail.maihai86.exam.model.User user) {
        this(userID, password, enabled, accountNonExpired, credentialsNonExpired, accountNonLocked, authorities, user, null, null);
    }

    public LocalUser(final String userID, final String password, final boolean enabled, final boolean accountNonExpired, final boolean credentialsNonExpired,
                     final boolean accountNonLocked, final Collection<? extends GrantedAuthority> authorities, final gmail.maihai86.exam.model.User user, OidcIdToken idToken,
    ...
    public static LocalUser create(gmail.maihai86.exam.model.User user, Map<String, Object> attributes, OidcIdToken idToken, OidcUserInfo userInfo) {
    ...
    public gmail.maihai86.exam.model.User getUser() {
        return user;
    }
}
